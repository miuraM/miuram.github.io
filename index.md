...
page_sections:
  - template: navigation-header-w-button
    block: header-2
    logo: "/uploads/2023/img/m-logo.svg"
    navigation:
      - link: "/"
        link_text: About Me
      - link: "#resume"
        link_text: Resume
      - link: "#recent_project"
        link_text: Recent Projects
      - link: "#skills"
        link_text: Skills
    cta:
      url: https://github.com/miuraM
      button_text: GitHub
  - template: hero-banner-w-image
    block: hero-2
    slug: features
    headline: About Me
    content: I am a full stack software engineer living in Tokyo, Japan.<br>I find it challenging and passionate to develop sustainable and scalable systems and work on end-to-end products that create impact.
    cta:
      enabled: true
      url: https://github.com/miuraM
      button_text: "Resume"
